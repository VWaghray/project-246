...
def ethereum_block():
	...
	gas_price_in_CAD = gas_price_in_ether*2322.59
	gas_price_in_USD = gas_price_in_ether*1671.87
	gas_price_in_pounds = gas_price_in_ether*1310.58
	value_in_ether["text"] = "Value of gas in Ether: ETH "+str(gas_price_in_ether)
	value_in_dollar["text"] = "Value of gas in CAD: $ "+str(gas_price_in_CAD)
	value_in_rupees["text"] = "Value of gas in USD: $ "+str(gas_price_in_USD)
